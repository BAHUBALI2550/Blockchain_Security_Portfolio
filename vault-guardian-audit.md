...
- [Himanshu Singh](enter your URL here)
...
- [Executive Summary](#executive-summary)
  ...
  - [Low](#low)
    ...
    - [\[L-3\] functions not used internally could be marked `external`](#l-3-function-not-used-internally-could-be-marked-external)
